...
def init():
    if not os.path.exists(r'D:\PythonProjects\weibo_django\Dashboard\spider_ai\ai_weibo_content.csv'):
        with open(r'D:\PythonProjects\weibo_django\Dashboard\spider_ai\ai_weibo_content.csv', 'w', newline='',
                  encoding='utf-8') as f:
            writer = csv.writer(f)
            writer.writerow([
                'id',
...
def write_row(row):
    with open(r'D:\PythonProjects\weibo_django\Dashboard\spider_ai\ai_weibo_content.csv', 'a', newline='',
              encoding='utf-8') as f:
        writer = csv.writer(f)
        writer.writerow(row)
